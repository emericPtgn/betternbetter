    ...
    <div className='w-full h-full'>
      <div className='bg-newWhite-100 w-full h-full px-10 py-10'>
        <div className='w-full h-full grid grid-cols-1 md:grid-rows-auto grid-rows-auto bg-white-100 gap-10 rounded-2xl bg-white drop-shadow-2xl py-10'>
          ...
          <div className='h-fit text-center font-montserrat font-medium text-xl px-10'>
          ...
          <div className='flex flex-col lg:flex-row justify-center items-center lg:justify-center gap-4'>
            ...
            <div className='flex flex-col w-[296px] md:w-[362px] h-[360px] border-l-8 border-t-8 border-b-[16px] border-r-[16px] border-black rounded-2xl bg-blue mx-auto md:mx-0'>
              <div className='flex flex-col h-full gap-y-6 py-6'>
                ...
                <div className='flex-grow flex flex-col items-center'>
                  ...
                  <span className='font-bold lg:text-5xl text-3xl text-white font-inter'>ADVENTURE</span>
                  <span className='font-bold md:text-3xl text-2xl font-inter'>79€</span>
                </div>
            ...
            <div className='flex flex-col w-[310px] md:w-[380px] h-[380px] border-l-8 border-t-8 border-b-[16px] border-r-[16px] border-black rounded-2xl bg-primary shadow-lg scale-105 mx-auto md:mx-0 '>
              <div className='flex flex-col h-full gap-y-6 py-6'>
                <div className='flex-grow flex justify-center'>
                  <img src={fusee} alt='' />
                </div>
                <div className='flex-grow flex flex-col items-center'>
                  <span className='font-bold lg:text-3xl text-2xl text-white-100 font-inter'>PASS</span>
                  <span className='font-bold lg:text-5xl text-3xl text-white font-inter'>EXPLORER</span>
                  <span className='font-bold md:text-3xl text-2xl font-inter'>119€</span>
                </div>
                <div className='h-1/4 flex items-center justify-center'>
            ...
            <div className='flex flex-col w-[296px] md:w-[362px] h-[360px] border-l-8 border-t-8 border-b-[16px] border-r-[16px] border-black rounded-2xl bg-slate-300 mx-auto md:mx-0'>
              <div className='flex flex-col h-full gap-y-6 py-6'>
                <div className='flex-grow flex justify-center'>
                ...
                <div className='flex-grow flex flex-col items-center'>
                  <span className='font-bold lg:text-3xl text-2xl text-white-100 font-inter'>PASS</span>
                  <span className='font-bold lg:text-5xl text-3xl text-white font-inter'>JOURNEY</span>
                  <span className='font-bold md:text-3xl text-2xl font-inter'>179€</span>
                </div>
                <div className='h-1/4 flex items-center justify-center'>
